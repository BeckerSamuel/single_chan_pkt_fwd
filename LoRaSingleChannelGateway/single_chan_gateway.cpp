...
int dio0  = 0xff;
int RST   = 0xff;
// The used SPI-Channel needs to be selected in the "LoRa.h"-file
...
map<int, string> configs; //device id to config
map<string, string> types; //devcie type to message struct
